...
def main():
    ...
    addr_A = wallet.getnewaddress("addr_A", "legacy")
    addr_B = wallet.getnewaddress("addr_B", "legacy")
    addr_C = wallet.getnewaddress("addr_C", "legacy")
    print("-" * 60)
    print("Generated Legacy Addresses:")
    print(f"  Address A (Sender):   {addr_A}")
    print(f"  Address B (Receiver): {addr_B}")
    print(f"  Address C (Extra):      {addr_C}")
    print("-" * 60)

    # Generate 101 blocks for funding.
    print("Generating 101 blocks for funding...")
    ...
    # Create transaction from A -> B: send 0.5 BTC.
